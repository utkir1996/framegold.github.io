                                            ...
                                            <div class="shop-list product-item">
                                                ...
                                                <div class="product-info">
                                                    ...
                                                    <ul class="action-button">
                                                        ...
                                                        <li id="liModalList">
                                                            <a href="<?= \yii\helpers\Url::to(['products/modal','id'=>$product->id])?>" id="modalProductList" data-toggle="modal"  data-target="#productModal" data-id="<?=$product->id?>" title="Quickview"><i class="zmdi zmdi-zoom-in"></i></a></li>
                                                        <li>
